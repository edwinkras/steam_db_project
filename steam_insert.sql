...
VALUES (1, 1, 'CD Projekt Red', 'CD Projekt', 59.99),
       (2, 2, 'id Software', 'Bethesda', 39.99),
       (3, 3, 'Treyarch', 'Activision', 49.99),
       (4, 4, 'Capcom', 'Capcom', 29.99),
       (5, 5, 'Square Enix', 'Square Enix', 69.99),
       (6, 6, 'Rockstar Games', 'Rockstar Games', 59.99),
       (7, 7, 'Bandai Namco', 'Bandai Namco', 59.99),
       (8, 8, 'NetherRealm Studios', 'Warner Bros', 49.99),
       (9, 9, 'Square Enix', 'Square Enix', 19.99),
       (10, 10, 'Naughty Dog', 'Sony', 59.99),
       (11, 11, 'EA Redwood Shores', 'Electronic Arts', 39.99),
