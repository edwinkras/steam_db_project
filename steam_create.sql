...
CREATE TABLE games -- add plenty of games there, I got names ready for all of that
(
...
(
    ...
    friends_with  INTEGER, -- this is for the uid to be called
...
(
    ...
    FOREIGN KEY (gid) REFERENCES games (gid)
-- I didn't know if I should've included like just a simple games TEXT or have a gid here, but also I did use up all of my games for the library so I got lost in the end I'm really sorry
);
